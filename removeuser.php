...
<body style="background-color : #E8A1F5;">
<?php
    include 'config.php';
...
<div class="container">
        <h2 class="text-center pt-4" style="color : black; background-color: #E8A1F5;">REMOVE USERS</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="removeuserrq.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn-danger"style="background-color : #E8A1F5;" style="color: black;" style="border-radius:0%;">Remove</button></a></td> 
                    </tr>
                <?php
                        $cnt=$cnt+1;
                    }
